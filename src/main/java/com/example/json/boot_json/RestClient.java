...
public class RestClient {
    ...
    private String getUsers() {
        ...
        System.out.println(result.getHeaders().getFirst("Set-Cookie").split(";")[0]);
        return result.getHeaders().getFirst("Set-Cookie").split(";")[0];
        ...
        responseHeaders.add(getUsers(),"http://91.241.64.178:7081/api/users");
